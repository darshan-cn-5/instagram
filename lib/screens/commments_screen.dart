// ignore_for_file: avoid_print, prefer_typing_uninitialized_variables, use_super_parameters, library_private_types_in_public_api
...
import 'package:instagram1/widgets/comment_card.dart';
        ...
        builder: (context,
          ...
          return ListView.builder(
            ...
            itemBuilder: (ctx, index) => GestureDetector(
              onTap: () {
                print("uid is ${snapshot.data!.docs[index]['uid']}");
